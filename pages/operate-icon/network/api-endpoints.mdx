...
API Endpoints increase the bandwidth of the ICON network. This allows users to more easily access information from the blockchain. There are many [_decentralized applications (dApps)_](/concepts/decentralized-applications-dapps) built on ICON, and they all need to access an API Endpoint in some way.
...
See the [How to run an API endpoint](../../getting-started/how-to-run-an-api-endpoint.md) guide
