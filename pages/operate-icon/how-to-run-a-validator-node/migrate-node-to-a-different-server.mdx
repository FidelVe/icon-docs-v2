...
[How to create a wallet account](../how-to-create-a-wallet-account)
...
- **Validator Block Check:** You can refer to this tutorial to check if a validator is missing blocks, which can be helpful during the migration process: [Validator Block Check Tutorial](../../support/advanced-topics/validator-nodes/how-to-check-if-a-validator-is-missing-blocks).
...
- [How to Set Up a Keystore on a Validator Node](../../support/advanced-topics/validator-nodes/how-to-setup-a-keystore-on-a-validator-node).

- [Node Operation and Configuration](../../support/advanced-topics/validator-nodes/node-operation-and-configuration).
