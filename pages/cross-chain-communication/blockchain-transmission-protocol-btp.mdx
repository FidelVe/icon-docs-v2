...
dApps interact with BTP through the xCall contract. Testnet xCall contract addresses are listed below. For more information on xCall, see the [xCall section](/xcall/what-is-xcall) and [standard](https://github.com/icon-project/IIPs/blob/master/IIPS/iip-52.md)
