...
If you dont have the goloop CLI installed in your computer please follow [these instructions](../../concepts/computational-utilities/goloop/setup).

### Check if a Public Key exists

To verify if a PRep address has already registered a Public Key using the [goloop CLI](../../concepts/computational-utilities/goloop) you can use the following command:
