...
| estimatedICX | T\_INT     | true     | Estimated amount in loop1000 I-Score == 1 loop |
...
| website     | T\_STRING  | true     | P-Rep homepage url "https://abc.example.com"                                       |
| detailes    | T\_STRING  | true     | Url including P-Rep detail information "https://abc.example.com/details/" |
...
| website     | T\_STRING  | false    | P-Rep homepage url "https://abc.example.com"                                       |
| detailes    | T\_STRING  | false    | Url including P-Rep detail information "https://abc.example.com/details/" |
...
| irep                    | T\_INT       | true     | Incentive rep used to calculate the reward for P-RepLimit: +- 20% of the previous valueUnit: loop                   |
...
| Key          | VALUE Type | Required | Description                                                     |
| ------------ | ---------- | -------- | --------------------------------------------------------------- |
| startRanking | T\_INT     | false    | Default: 1P-Rep list which starts from start ranking |
