...
The three main categories of ways to perform a transaction are as follows: through the [Hana wallet](https://icon.community/hanawallet/), through a [decentralized application (dApp)](/concepts/decentralized-applications-dapps), or via the [ICON JSON-RPC API](https://github.com/icon-project/goloop/blob/master/doc/jsonrpc_v3.md).
