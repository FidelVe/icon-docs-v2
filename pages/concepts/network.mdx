...
The core ICON Network consists of three layers: _Users_, [_API Endpoints_](/concepts/network/api-endpoints), and [_Validator nodes_](/concepts/network/validator-nodes). The latter two topics are discussed in their own sections. Users are explained briefly on this page.
