...
The price of ICX is correlated with the value of computational power on the ICON Network. The actual _cost to use_ the computational power on the ICON Network is called [_STEP_](./step), and is described in its own section of the documentation.
...
[Staking](/concepts/economics/staking), in the general context of cryptocurrency, is defined as follows by the ICON Community Glossary:
...
[More on transactions](/concepts/computational-utilities/transactions)

### Querying ICX

Users can query the ICX balance of any [account](/concepts/computational-utilities/accounts) by inspecting the "balances" database at the address of the account.
